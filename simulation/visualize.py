...
for node, data in G.nodes(data=True):
    ...
    elif ntype == "electrode":
        node_colors.append("#f39c12")
    elif ntype == "enzyme":
        node_colors.append("#e74c3c")
    elif ntype == "mediator":
        node_colors.append("#9b59b6")
    elif ntype == "electron_carrier":
        node_colors.append("#3498db")
    elif ntype == "electrical":
...
ax2.set_title(
    f"Bottleneck: {results['bottleneck_edge']}\n{results['max_power_density_uW_cm2']:.1f} µW/cm² max",
    fontsize=12,
)
ax2.set_xscale("log")
...
plt.tight_layout()
plt.savefig("electron_transport_graph.png", dpi=150, bbox_inches="tight")
...
ax3.axhline(
    12.5, color="g", linestyle="--", alpha=0.5, label="Empa baseline (12.5 µW/cm²)"
)
