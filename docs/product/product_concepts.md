...
> **Tools:** `simulation/product_explorer.py` · `simulation/manufacturing_bom.py`
...
*Generated by `simulation/product_explorer.py` · See `simulation/manufacturing_bom.py` for cost model*
